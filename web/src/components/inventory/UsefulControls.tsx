              ...
              <div ref={refs.setFloating} {...getFloatingProps()} className="useful-controls-dialog" style={styles}>
                ...
                <div className="useful-controls-content-wrapper">
                  <p>
                    <kbd>RMB</kbd>
                    <br />
                    {Locale('ui_rmb', 'Open item context menu')}
                  </p>
                  <p>
                    <kbd>ALT + LMB</kbd>
                    <br />
                    {Locale('ui_alt_lmb', 'Fast use an item')}
                  </p>
                  <p>
                    <kbd>CTRL + LMB</kbd>
                    <br />
                    {Locale('ui_ctrl_lmb', 'Fast move a stack of items into another inventory')}
                  </p>
                  <p>
                    <kbd>SHIFT + Drag</kbd>
                    <br />
                    {Locale('ui_shift_drag', 'Split item quantity into half')}
                  </p>
                  <p>
                    <kbd>CTRL + SHIFT + LMB</kbd>
                    <br />
                    {Locale('ui_ctrl_shift_lmb', 'Fast move half a stack of items into another inventory')}
                  </p>
